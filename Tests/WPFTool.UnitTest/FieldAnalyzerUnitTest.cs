...
namespace SeanTool.CSharp.WPFTool.Test
{
    ...
    public class FieldAnalyzerUnitTest
    {
        ...
        /// </summary>
        [Fact(DisplayName = "一般 CLR 型別 - 掃描出所有可讀屬性，DisplayName/Order 取自 Attribute")]
        ...
        /// </summary>
        [Fact(DisplayName = "Nullable 屬性 - PropertyType 保留 Nullable&lt;T&gt;，NonNullableType 展開為底層型別")]
        ...
        /// </summary>
        [Fact(DisplayName = "GetValue/SetValue - 一般 CLR 物件可透過 FieldDescriptor 讀寫實例")]
        ...
        /// </summary>
        [Fact(DisplayName = "自訂 Attribute - GetAttribute 可取得屬性上標記的自訂 Attribute")]
        ...
        /// </summary>
        [Fact(DisplayName = "DataTable 支援 - 傳入 DataRowView 樣本時，欄位掃描結果依 DataTable 的 Columns 而非 DataRowView 的 CLR 屬性")]
        ...
        /// </summary>
        [Fact(DisplayName = "DataTable 支援 - 以單一實例(DataRowView)呼叫 Analyze(object) 便利多載，等同傳入型別+樣本")]
        ...
        /// </summary>
        [Fact(DisplayName = "DataTable 支援 - 可透過 FieldDescriptor 直接讀寫 DataRowView 對應的儲存格")]
        ...
        /// </summary>
        [Fact(DisplayName = "未提供樣本實例時，動態提供屬性的型別(DataRowView)沒有固定欄位可掃描，僅回退為型別本身的 CLR 屬性，不拋例外")]
        ...
        /// </summary>
        [Fact(DisplayName = "ReadOnlyAttribute - 標記 [ReadOnly(true)] 的屬性即使有 Setter 也應視為唯讀")]
