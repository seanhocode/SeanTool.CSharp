...
namespace SeanTool.CSharp.WPFTool.Test
{
    ...
    public class IEnumerableConverterUnitTest
    {
        ...
        /// </summary>
        [Fact(DisplayName = "null 資料來源 - 回傳 null")]
        ...
        /// </summary>
        [Fact(DisplayName = "一般 IEnumerable - 原樣回傳，不做轉換")]
        ...
        /// </summary>
        [Fact(DisplayName = "DataTable(IListSource) - 轉換為其 DefaultView，內容與 Rows 一致")]
        ...
        /// </summary>
        [Fact(DisplayName = "不支援的型別 - 拋出 ArgumentException")]
