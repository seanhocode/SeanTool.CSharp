...
namespace SeanTool.CSharp.WPFTool.Test
{
    public class DynamicDataGridPropertyMetadataUnitTest
    {
        ...
        /// </summary>
        [Fact(DisplayName = "元數據讀取 - 支援 DisplayName 和唯讀屬性")]
        ...
        /// </summary>
        [Fact(DisplayName = "DataTable 支援 - 透過 DataRowView 樣本掃描出 DataTable 的實際欄位")]
        ...
        /// </summary>
        [Fact(DisplayName = "未提供樣本實例時，DataRowView 型別本身沒有動態欄位可掃描（只會看到其固定 CLR 屬性）")]
