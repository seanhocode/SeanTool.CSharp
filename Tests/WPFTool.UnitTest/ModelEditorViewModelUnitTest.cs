...
namespace SeanTool.CSharp.WPFTool.Test
{
    ...
    public class ModelEditorViewModelUnitTest
    {
        ...
        /// </summary>
        [Fact(DisplayName = "DataTable 支援 - 傳入 DataRowView 時，能依 DataTable 的 Columns 自動產生可編輯的 PropertyItem")]
        ...
        /// </summary>
        [Fact(DisplayName = "DataTable 支援 - 編輯 DataRowView 欄位後儲存(ApplyChange)可正確寫回 DataTable")]
        ...
        /// </summary>
        [Fact(DisplayName = "唯讀欄位保護 - DataColumn.ReadOnly=true 的欄位即使暫存值改變，ApplyChange 也不會寫回")]
        ...
        /// </summary>
        [Fact(DisplayName = "一般 CLR 物件 - 既有行為不受共用欄位分析器影響，仍可正常掃描與編輯")]
